...
-- Drop the old function versions to avoid conflicts
DROP FUNCTION IF EXISTS public.transfer_money(uuid, text, numeric);
DROP FUNCTION IF EXISTS public.transfer_money(uuid, text, numeric, text, text, text);
